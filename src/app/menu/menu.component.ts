...
import { Plato } from '../compartido/plato'; // importamos el plato
...
const PLATOS: Plato[] = [
  ...
  {
    id: '2',
    nombre: 'Pollo Frances',
    image: '/assets/images/pollo.png',
    categoria: 'Almuerzos',
    destacado: false,
    etiqueta: 'Nuevo',
    precio: '25.000',
    descripcion: 'Una nueva experiencia de sabores Marlenys un almuerzo por excelencia, Ven y prueba vive la mejor de nuestro delicioso Pollo frances.'
  },
  {
    id: '3',
    nombre: 'Pancakes',
